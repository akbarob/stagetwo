    ...
    <div className="flex gap-4 overflow-y-auto relative">
      ...
      <section className="h-screen overflow-y-auto lg:flex-1 flex flex-col p-4 gap-10">
        <div className="relative">
          <div className="relative  max-w-[1198px] h-[449px] rounded-3xl">
            <Image
        ...
        {/* <div> */}
        <div className="lg:flex justify-between mb-10 w-full font-semibold">
        ...
        <div className="lg:flex gap-4">
          <div className="gap-10 flex flex-col">
            ...
            <div className="lg:flex justify-between items-center w-full">
              ...
              <div className="mt-10 lg-mt-0 relative w-[350px] h-[299px]">
                <Image
                  className="w-full"
